  ...
  return (
    <section id="contact" className="bg-[#F0EAE0] py-24">
      <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
        ...
        {/* Left: Info */}
        <div>
          <p className="text-sm uppercase tracking-[0.2em] text-[#C9A09A] mb-3">Book an Appointment</p>
          <h2
          ...
          <p className="text-[#6B4C40] text-sm leading-relaxed mb-10">
            Fill in your booking details and hit <strong>Confirm on WhatsApp</strong> — your request goes straight to us and we&apos;ll confirm within 24 hours.
          </p>
          ...
          <div className="flex flex-col gap-5 text-sm text-[#6B4C40]">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <p className="font-semibold text-[#3D2B20] mb-0.5">WhatsApp</p>
                <p>+60 11 2578 4475</p>
              </div>
            </div>
